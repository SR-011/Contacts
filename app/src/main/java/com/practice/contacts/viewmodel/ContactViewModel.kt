...
class ContactsViewModel(private val mApplication: Application) : AndroidViewModel(mApplication) {
    ...
    fun fetchContacts() {
        viewModelScope.launch {
            ...
            Log.d("Sohel", "fetchContacts: $contacts")
            Log.d("Sohel", "fetchContacts: $contactNumbers")
            Log.d("Sohel", "fetchContacts: $contactEmails")
        }
    }
            ...
            0 -> {
                ...
                cursor.apply {
                    ...
                    while (moveToNext()) {
                        ...
                        if (name != null) {
                           mutableContactList.postValue(Contacts)
                        }
                    }
                }
                cursor.close()
